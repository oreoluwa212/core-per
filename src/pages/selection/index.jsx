      ...
      <div>
        <div>
          ...
          <div className="pt-14 pb-10 text-center">
            <h2 className="md:text-[32px] text-[20px] fw-bold font-abril uppercase">
              What brings you to Core?
            </h2>
        ...
        <div className="flex justify-center flex-col lg:flex-row gap-[40px] px-6">
          ...
          >
            ...
            <div className="pt-20 text-center">
              ...
              <h6
                className={`text-[20px] ${
                  selectedOption === "admin" ? "text-white" : ""
                }`}
              >
          ...
          >
            ...
            <div className="pt-20 text-center">
              ...
              <h6
                className={`text-[20px] ${
                  selectedOption === "client" ? "text-white" : ""
                }`}
              >
                I want to shop for art pieces
              </h6>
            </div>
          </div>
        </div>
        <div className="pt-14 flex justify-center px-6">
          <Link
            to={selectedOption === "admin" ? "/signup/admin" : "/signup/client"}
          >
            <button
