                        ...
                        <div className="my-auto w-full rounded-[16px] p-6">
                            ...
                            <form onSubmit={handleSubmit(onSubmit)}>
                                ...
                                <button
                                    ...
                                    className={`w-full rounded-[15px] py-[16px] mt-5 text-center text-base uppercase sm:text-[18px] ${allCriteriaMet ? "bg-primary-500" : "bg-gray-300"} transition duration-200`}
                                >
                                    Sign Up
                                </button>
                                ...
                                {/* Success Message */}
                                {submitSuccess && (
                                    <p className="text-green-500 text-sm mt-4">Signup successful! Redirecting...</p>
                                )}
                            </form>
                        </div>
                    </div>
