            ...
            <div>
              <div className="h-[60px] flex gap-[20px] border-[1px] border-[#AFAFAF] justify-center rounded-[8px] items-center mt-[20px]">
                ...
                >
                  ...
                  />
                  <path
                    d="M12.5 22.0003C15.083 22.0003 17.43 21.0118 19.2045 19.4043L16.1095 16.7853C15.0718 17.5745 13.8037 18.0014 12.5 18.0003C9.899 18.0003 7.6905 16.3418 6.8585 14.0273L3.5975 16.5398C5.2525 19.7783 8.6135 22.0003 12.5 22.0003Z"
                    fill="#4CAF50"
                  />
                  <path
              ...
              <div className="my-auto w-full rounded-[16px] p-6">
                ...
                <form onSubmit={handleSubmit(onSubmit)}>
                  ...
                  <div className="relative mb-4">
                    ...
                    {passwordTyping && (
                      <div className="mt-2">
                        ...
                        >
                          {passwordCriteria.specialChar ? "✓" : "✗"} At least
                  ...
                  <button
                    ...
                    className={`w-full rounded-[15px] py-[16px] mt-5 text-center text-base uppercase sm:text-[20px] ${
                      allCriteriaMet
                        ? "bg-[#008080] text-white cursor-pointer"
